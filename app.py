...
# Adicionei cache para evitar que o app trave ao baixar o CSV várias vezes
@st.cache_data
def carregar_dados():
...
with st.sidebar.expander("🏢 Tamanho da Empresa"):
    ...
    tamanhos_selecionados = st.sidebar.multiselect("Tamanho:", tamanhos_disponiveis, default=tamanhos_disponiveis)
